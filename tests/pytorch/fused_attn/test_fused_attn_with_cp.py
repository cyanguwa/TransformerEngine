...
model_configs_flash_attn = {
    ...
    "cp_1_4": ModelConfig(2, 12, 12, 128, 4096, 4096, 0.0, "causal", "no_bias", chunk_size=1024),  # MHA with chunks
...
model_configs_fused_attn = {
    ...
    "cp_1_5": ModelConfig(2, 12, 12, 128, 4096, 4096, 0.0, "causal", "no_bias", chunk_size=1024),  # MHA
    "cp_2_0": ModelConfig(2, 12, 2, 128, 4096, 4096, 0.0, "causal", "no_bias"),  # GQA
    "cp_2_1": ModelConfig(2, 12, 2, 128, 4096, 4096, 0.0, "no_mask", "no_bias"),  # GQA
