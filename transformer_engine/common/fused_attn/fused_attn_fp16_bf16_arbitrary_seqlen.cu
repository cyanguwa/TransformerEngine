...
void fused_attn_arbitrary_seqlen_bwd_impl(int64_t b, int64_t h, int64_t s_q, int64_t s_kv, int64_t d,
    ...
    try {
        ...
        auto get_plan = [&](CacheType &cache, const FADescriptor &descriptor) {
            ...
            generateMatrixStrides(b, h, s_q, s_kv, d, k_transpose_stride, layout, NVTE_QKV_Matrix::NVTE_K_Matrix_Transpose);

            int64_t v_transpose_dim [4] =  {b, h, d, s_kv};
            int64_t v_transpose_stride [4];
            generateMatrixStrides(b, h, s_q, s_kv, d, v_transpose_stride, layout, NVTE_QKV_Matrix::NVTE_V_Matrix_Transpose); // type is correct as V is transposed
            ...
            *///////////////////////////////////////////////////////////////////////////////
            ...
            generateMatrixStrides(b, h, s_q, s_kv, d, dqkv_stride, layout, NVTE_QKV_Matrix::NVTE_Q_Matrix);
            // Outputs of backprop
            ...
            *///////////////////////////////////////////////////////////////////////////////
            ...
            int64_t kStride [4];
            generateMatrixStrides(b, h, s_q, s_kv, d, kStride, layout, NVTE_QKV_Matrix::NVTE_K_Matrix);
