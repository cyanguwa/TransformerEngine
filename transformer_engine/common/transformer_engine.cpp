...
void nvte_set_grouped_tensor_param_v2(NVTEGroupedTensor tensor, NVTEGroupedTensorParam param, const void *buf,
  size_t size_in_bytes) {
// Check attribute and buffer
NVTE_CHECK(param < kNVTENumGroupedTensorParams, "Invalid NVTEGroupedTensorParam (got ", static_cast<int>(param),
")");
NVTE_CHECK(tensor != nullptr, "Grouped tensor pointer can't be NULL.");
...
void nvte_get_grouped_tensor_param_v2(const NVTEGroupedTensor tensor, NVTEGroupedTensorParam param, void *buf,
  size_t size_in_bytes, size_t *size_written) {
using namespace transformer_engine;
