...
std::vector<at::Tensor> fused_attn_fwd(
  ...
  if ((page_table_k.has_value()) && (page_table_v.has_value())) {
    ...
    std::vector<size_t> page_table_k_shape{page_table_k_sizes.begin(),
                                                  page_table_k_sizes.end()};
    auto page_table_v_sizes = page_table_v.value().sizes().vec();
    std::vector<size_t> page_table_v_shape{page_table_v_sizes.begin(),
                                                   page_table_v_sizes.end()};
  ...
  nvte_fused_attn_fwd(te_Q.data(), te_K.data(), te_V.data(), te_Bias.data(), te_S.data(),
		      ...
		      te_page_table_k.data(), te_page_table_v.data(),
		      te_rng_state.data(), max_seqlen_q,
